...
module.exports = {"symbolSize":140,"numOfRows":3,"numOfReels":3,"numOfSpinsBeforeStop":2,"delayBeforeSpinNextReel":300,"spinAnimationTimeInSec":2,"spinAnimTimingFunc":"ease-in-out"}
	...
	_createClass(Game, [{
		...
		value: function initReels() {
			...
			for (var i = 0; i < _settings2.default.numOfReels; i++) {
				this.reels.push(new _Reel2.default());
...
var Reel = function () {
	...
	_createClass(Reel, [{
		key: 'initSymbols',
		value: function initSymbols(symbolsArray) {
		...
		value: function addSpinningSymbols() {
			for (var i = 0; i < _settings2.default.numOfSpinsBeforeStop * _settings2.default.numOfRows; i++) {
				var symbol = new _Symbol3.default(10);
		...
		value: function addFinalSymbols() {
			for (var i = 0; i < _settings2.default.numOfRows; i++) {
				var symbol = new _Symbol3.default(i * 3 + 1);
				this.reelNode.insertBefore(symbol.node, this.reelNode.firstChild);
			}
		}
	}, {
